...
Metadata and other information can be passed along a series of requests using [request context](grains/request_context.md). Request context can be used for holing distributed tracing information or any other user-defined values.
